...
local itemTemplates = {
   {id=1,type="Weapon",name="Weapon",value = 10, imagePath = "resource/release_v1.2-single_100.png"},
   {id=2,type="Armor",name="shield",value = 5, imagePath = "resource/release_v1.2-single_98.png"},
   {id=3,type="Potion",name="healthPotion",value = 2, imagePath = "resource/release_v1.2-single_92.png"},
}
