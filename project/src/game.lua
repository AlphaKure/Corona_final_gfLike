...
local itemTemplates = {
   ...
   {id = 19, type = "Armor", name = "光之護甲", defense =2,element =nil, value =3,rare =1, imagePath = "resource/icon/release_v1.2-single_7.png",effect =nil,describe="提供玩家2點光屬性護甲"},
   ...
   {id = 27, type = "Armor", name = "無屬性護甲", defense =3,element =nil, value =3,rare =1,effect =nil,describe="提供玩家3點無屬性護甲", imagePath = "resource/icon/release_v1.2-single_16.png"},
   ...
   {id = 29, type = "Armor", name = "小型吸收護甲", defense =2,element =nil, value =3,rare =1,effect =nil,describe="提供玩家2點護甲" ,imagePath = "resource/icon/release_v1.2-single_18.png"},
   ...
   {id = 44, type = "Armor", name = "暗黑護甲", defense =4,element =nil, value =4,rare =1,effect =nil,describe="提供玩家4點護甲，雖然很黑" , imagePath = "resource/icon/release_v1.2-single_35.png"},
