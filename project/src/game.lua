...
local itemTemplates = {
   ...
   {id = 48, type = "Potion", name = "冰封", dice_amount =1,dice_face =5,recover_type ="attack",value =3,rare =3,effect =nil,describe="對敵人造成1d5傷害", imagePath = "resource/icon/release_v1.2-single_40.png"},
   {id = 49, type = "Potion", name = "隕石墜落", dice_amount =1,dice_face =6,recover_type ="attack",value =4,rare =4,effect =nil,describe="對敵人造成1d6傷害", imagePath = "resource/icon/release_v1.2-single_41.png"},
   {id = 50, type = "WeaponAdd", name = "燃燒吧!武器", damage =2,element =nil, value =2,rare =2,effect =nil,describe="提升武器2點火屬性傷害", imagePath = "resource/icon/release_v1.2-single_42.png"},
   {id = 51, type = "Potion", name = "岩漿", dice_amount =1,dice_face =4,recover_type ="attack",value =2,rare =2,effect =nil,describe="對敵人造成1d4傷害", imagePath = "resource/icon/release_v1.2-single_43.png"},
   {id = 52, type = "Potion", name = "燃燒箭矢", dice_amount =2,dice_face =3,recover_type ="attack",value =3,rare =3,effect =nil,describe="對敵人造成2d3傷害", imagePath = "resource/icon/release_v1.2-single_44.png"},
   {id = 53, type = "Potion", name = "火焰電弧", dice_amount =1,dice_face =5,recover_type ="attack",value =3,rare =3,effect =nil,describe="對敵人造成1d5傷害", imagePath = "resource/icon/release_v1.2-single_45.png"},
   {id = 54, type = "Potion", name = "死亡宣告", dice_amount =1,dice_face =40,recover_type ="attack",value =5,rare =5,effect =nil,describe="對敵人造成1d40傷害，有機會秒殺敵人", imagePath = "resource/icon/release_v1.2-single_46.png"},
   {id = 55, type = "Potion", name = "月光",dice_amount =2,dice_face =2,recover_type ="health",value =3,rare =3,effect =nil,describe="回復2d2的生命值", imagePath = "resource/icon/release_v1.2-single_47.png"},
   {id = 56, type = "WeaponAdd", name = "歷戰強化", damage =3,element =nil, value =4,rare =4,effect =nil,describe="提升武器4點傷害", imagePath = "resource/icon/release_v1.2-single_48.png"},
   {id = 57, type = "Potion", name = "慘忍一擊", dice_amount =1,dice_face =10,recover_type ="attack",value =5,rare =5,effect =nil,describe="對敵人造成1d10傷害", imagePath = "resource/icon/release_v1.2-single_49.png"},
   {id = 58, type = "Potion", name = "收割", dice_amount =1,dice_face =10,recover_type ="attack",value =5,rare =5,effect =nil,describe="對敵人造成1d10傷害", imagePath = "resource/icon/release_v1.2-single_50.png"},
   {id = 59, type = "Armor", name = "大 岩 壁", defense =4,element =nil, value =3,rare =3,effect =nil,describe="提供玩家4點無屬性護甲", imagePath = "resource/icon/release_v1.2-single_51.png"},
   {id = 60, type = "Potion", name = "投石攻擊",dice_amount =1,dice_face =4,recover_type ="attack",value =2,rare =2,effect =nil,describe="對敵人造成1d4傷害", imagePath = "resource/icon/release_v1.2-single_52.png"},
   {id = 61, type = "Potion", name = "泰山壓頂", dice_amount =2,dice_face =4,recover_type ="attack",value =2,rare =2,effect =nil,describe="對敵人造成2d4傷害", imagePath = "resource/icon/release_v1.2-single_54.png"},
   {id = 62, type = "Potion", name = "天崩地裂", dice_amount =2,dice_face =6,recover_type ="attack",value =3,rare =4,effect =nil,describe="對敵人造成2d6傷害", imagePath = "resource/icon/release_v1.2-single_55.png"},
   {id = 63, type = "WeaponAdd", name = "劍刃強化", damage =2,element =nil, value =2,rare =2,effect =nil,describe="提升武器2點傷害", imagePath = "resource/icon/release_v1.2-single_56.png"},
   {id = 64, type = "Armor", name = "大盾", defense =5,element =nil, value =4,rare =4,effect =nil,describe="提供玩家5點護甲", imagePath = "resource/icon/release_v1.2-single_57.png"},
   {id = 65, type = "Potion", name = "天降甘霖", dice_amount =2,dice_face =5,recover_type ="health",value =4,rare =4,effect =nil,describe="回復2d5的生命值", imagePath = "resource/icon/release_v1.2-single_58.png"},
   {id = 66, type = "Potion", name = "橫掃", dice_amount =1,dice_face =5,recover_type ="attack",value =3,rare =3,effect =nil,describe="對敵人造成1d5傷害", imagePath = "resource/icon/release_v1.2-single_59.png"},
   {id = 67, type = "Armor", name = "遠古裝甲", defense =5,element =nil, value =4,rare =4,effect =nil,describe="提供玩家5點護甲", imagePath = "resource/icon/release_v1.2-single_60.png"},
   {id = 68, type = "Armor", name = "秘鱗", defense =3,element =nil, value =2,rare =2,effect =nil,describe="提供玩家3點護甲", imagePath = "resource/icon/release_v1.2-single_61.png"},
   {id = 69, type = "Potion", name = "吐息",dice_amount =1,dice_face =4,recover_type ="attack",value =2,rare =2,effect =nil,describe="對敵人造成1d4傷害", imagePath = "resource/icon/release_v1.2-single_62.png"},
   {id = 70, type = "Potion", name = "龍之心", dice_amount =3,dice_face =6,recover_type ="health",value =5,rare =5,effect =nil,describe="回復3d6的生命值", imagePath = "resource/icon/release_v1.2-single_63.png"},
}
